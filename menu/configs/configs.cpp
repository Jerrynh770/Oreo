...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.antiaim.automatic_direction, false, crypt_str("Antiaim.automatic_direction"));
...
{
	std::string file = crypt_str("C:\\Oreo\\Configs\\") + config;
	json allJson;
...
{
	std::string file = crypt_str("C:\\Oreo\\Configs\\");
